...
def corner_opp_heuristic(game, player):
...
def edge_penalty_heuristic(game, player):
...
def avoid_corner_heuristic(game, player):
    moves = game.get_legal_moves(player)
    # try to avoid the corners
...
def custom_score(game, player, turns=0):
        ...
        return avoid_corner_heuristic(game, player)
